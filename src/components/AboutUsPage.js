  ...
  return (
    <div className="mainPage">
      ...
      <div className="grid-col-span-12 grid-row-start-2 container mt-5">
        <p className="mt-2 mx-auto width-80">{t("description.AboutUsPara1")}</p>
        <p className="m-t-4 mx-auto width-80">{t("description.AboutUsPara2")}</p>
        <p className="m-t-4 mx-auto width-80">{t("description.AboutUsPara3")}</p>
        <p className="m-t-4 mx-auto width-80">{t("description.AboutUsPara4")}</p>
        <p className="m-t-4 mx-auto width-80">{t("description.AboutUsPara5")}</p>
