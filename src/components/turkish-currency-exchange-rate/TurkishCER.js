  ...
  return (
    <section className="cer">
      <div className="section-branding flex-wrap">
        ...
        <time className="date" datetime={tryCoins?.last_update}>{tryCoins?.last_update ? formatDate(new Date(tryCoins.last_update)) : <Skeleton width={120} style={{opacity: '0.2'}} />}</time>
