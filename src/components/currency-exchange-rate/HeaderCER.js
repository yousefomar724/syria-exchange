  ...
  return (
    <section className="cer">
      <div className="section-branding">
        ...
        <time className="date" dateTime={coins?.last_update}>{coins?.last_update ? formatDate(new Date(coins.last_update)) : <Skeleton width={120} style={{opacity: '0.2'}} />}</time>
      ...
      <div className="cerToast">
        ...
        {curr1 ? curr1[0][1].slice(0, 12).map((city) => (
      ...
      <div className="seeMore">
        ...
        >
          {t("description.headerCERSeeMore")}
        </Link>
      </div>
    </section>
  );
