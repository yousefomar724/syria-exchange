  ...
  return (
    <section className="cer">
      <div className="section-branding">
        ...
        <time className="date" datetime={syGold?.last_update}>{syGold?.last_update ? formatDate(new Date(syGold.last_update)) : <Skeleton width={120} style={{opacity: '0.2'}} />}</time>
      </div>
      ...
      <div className="goldPricesToast">
        ...
        {SypGold ? SypGold[0].map((item, index) => (
