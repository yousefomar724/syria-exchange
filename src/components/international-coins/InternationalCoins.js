...
const InternationalCoins = ({  sectionClass, border, color }) => {
  ...
  return (
    <section className={sectionClass}>
      <div className="section-branding justify-content-center" style={{ padding: '10px'}}>
        <div className="heading" >
          <h2 className="title" style={{fontSize: '18px', padding: '3px 0', lineHeight: 1, ...(color && {color: color})}}>{t("description.internationalCoinsTitle")}</h2>
        </div>
      </div>
      ...
      <div className="InternationalCoinsToastDiv">
        ...
        >
          {data?.last_update ? formatDate(new Date(data.last_update)) : <Skeleton width={120} style={{opacity: '0.5'}} />}
        </div>
